...
const icons = [Shield, Lock, Database, FileText];
      ...
      <Container>
        ...
        <ComplianceGrid>
          ...
          >
            ...
            <SecurityList>
              {config.copy.compliance.security.slice(0, 2).map((item, index) => (
        ...
        <PolicyLinks
          ...
          viewport={{ once: true }}
        >
          <Button variant="outline" onClick={() => window.open(config.links.terms, '_blank')}>
            이용약관
          </Button>
          <Button variant="outline" onClick={() => window.open(config.links.privacy, '_blank')}>
            개인정보처리방침
          </Button>
        </PolicyLinks>
      </Container>
